//
//  EkooImageCropperViewController.m
//  Ekoo
//
...
@interface EkooImageCropperViewController ()
...
@implementation EkooImageCropperViewController
...
- (void)initControlBtn {
    UIView * backView = [[UIView alloc]initWithFrame:CGRectMake(0, VIEW_HEIGHT - 70, VIEW_WIDTH, 70)];
    [self.view addSubview:backView];
    backView.backgroundColor = [UIColor colorWithRed:0.1 green:0.1 blue:0.1 alpha:1.00];
    UIButton *cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, 10, 100, 50)];
    
    cancelBtn.titleLabel.textColor = [UIColor greenColor];
    [cancelBtn setTitle:@"取消" forState:UIControlStateNormal];
    [cancelBtn.titleLabel setFont:[UIFont boldSystemFontOfSize:18.0f]];
    [cancelBtn.titleLabel setTextAlignment:NSTextAlignmentCenter];
    [cancelBtn setTitleColor:UIColorFromRGB(0x2673C2) forState:UIControlStateNormal];
...
//    [cancelBtn.titleLabel setLineBreakMode:NSLineBreakByWordWrapping];
    ...
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.view.frame.size.width - 100.0f, 10, 100, 50)];
//    confirmBtn.titleLabel.textColor = [UIColor greenColor];
    [confirmBtn setTitle:@"确定" forState:UIControlStateNormal];
    [confirmBtn.titleLabel setFont:[UIFont systemFontOfSize:18]];
    [confirmBtn.titleLabel setTextAlignment:NSTextAlignmentCenter];
    [confirmBtn setTitleColor:UIColorFromRGB(0x2673C2) forState:UIControlStateNormal];
...
- (void)cancel:(id)sender {
    if (self.delegate && [self.delegate conformsToProtocol:@protocol(EkooImageCropperDelegate)]) {
